...
CARLA_PATH = 'D:/PAP/CARLA_0.9.8'  # Path to Carla root folder
...
WEIGHT_REWARDS_WITH_SPEED = 'discrete'  # 'discrete': -1 < 50kmh, 1 otherwise, 'linear': -1..1 with 0..100kmh, 'quadratic': -1..1 with 0..100kmh with formula: (speed / 100) ** 1.3 * 2 - 1
SPEED_MIN_REWARD = -1
SPEED_MAX_REWARD = 1
...
AGENT_CARLA_INSTANCE = []  # Empty list for first Carla instance or list in size of AGENTS with Carla instance bounds for agents, for example [1, 1, 2, 2]
